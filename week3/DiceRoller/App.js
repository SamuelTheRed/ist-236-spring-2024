...
import { StyleSheet, Text, View, Image, Linking, SafeAreaView, Button, Pressable } from "react-native";
...
export default function App() {
    ...
    if (userGuess !== "" && userGuessNum == diceSumNum) {
        resultText= <Text style={styles.rsultText}>You Won ${(userWagerNum * 5).toFixed(2)}</Text>
    }

    if (userGuess !== "" && userGuessNum !== diceSumNum) {
        resultText= <Text style={styles.rsultText}>You Lost ${(userWagerNum)}</Text>
    }
